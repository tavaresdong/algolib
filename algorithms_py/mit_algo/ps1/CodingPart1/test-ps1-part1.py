...
import profile
import pstats
from mit_algo.ps1.CodingPart1.peak_finder_1d import *
from mit_algo.ps1.CodingPart1.utils_1d import *
...
def isFast(filename):
    global array
    array = read_input(filename)
    # replace with runctx and globals() locals() to use array argument
    profile.runctx('slow_find_1d_peak(array)', globals(), locals(), '1d_slow_stats')
    profile.runctx('quick_find_1d_peak(array)', globals(), locals(), '1d_quick_stats')
